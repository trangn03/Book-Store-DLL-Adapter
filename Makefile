...
help:
	...
	@echo
	@echo "make test          ==> Run tests agains your book store"
...
#
CPP_Tests.o:	CPP_Tests.cpp DoublyLinkedList.hpp BookStore.hpp Book.hpp DoublyLinkedList.hpp puhp-tests/PuhPTests.h
	$(CC) $(CFLAGS) $< -o $@
